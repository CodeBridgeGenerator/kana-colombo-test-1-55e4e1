...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Images</label><div className="m-0 ml-3" ><UploadFilesToS3 type={'single'}/></div></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">Details</label><p className="m-0 ml-3"  dangerouslySetInnerHTML={{__html: _entity?.Details}}></p></div>
