...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="roles-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-11" role="roles-datatable">
                    <RolesDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
...
/>            
      ...
      />
            ...
            <RolesCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
