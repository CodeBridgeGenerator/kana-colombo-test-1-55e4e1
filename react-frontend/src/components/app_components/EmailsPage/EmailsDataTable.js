...
const EmailsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
  ...
  const handleHideDialog = () => {
    ...
    return (
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Emails Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
          serviceName="emails"            
          onUploadComplete={() => {
      ...
      <Dialog header="Search Emails" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
